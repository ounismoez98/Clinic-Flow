...
public class AnalysisMessageProducer {
	private static final String ANALYSIS_EXCHANGE = RabbitMqConfig.ANALYSIS_EXCHANGE;
	private static final String ANALYSIS_ROUTING_KEY = RabbitMqConfig.ANALYSIS_ROUTING_KEY;
